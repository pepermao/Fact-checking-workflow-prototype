...
const FloatingLinkToolbar = () => {
    const { isEditing, linkPositioner, clickEdit, onRemove, onOpen, submitHref, href, setHref, cancelHref } =
useFloatingLinkState();
    ...
    const linkEditButtons = activeLink ? (
        <>
            <CommandButton commandName='openLink' onSelect={onOpen} icon="link" enabled />
            <CommandButton
